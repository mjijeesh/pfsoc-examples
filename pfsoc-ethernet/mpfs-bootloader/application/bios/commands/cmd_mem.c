 ...
 * File Name  : cmd_mem.c
 * Description: Command handlers for memory inspection, writing, copy, and testing.
 *******************************************************************************/
...
/**
 * @brief Shell handler for 'mem_read' command[cite: 31].
 * Usage: mem_read <address> [length][cite: 31]
 */
...
/**
 * @brief Shell handler for 'mem_write' command[cite: 31].
 * Usage: mem_write <address> <value>[cite: 31]
 */
...
/**
 * @brief Shell handler for 'mem_copy' command[cite: 31].
 * Usage: mem_copy <dst> <src> [count (32-bit words)][cite: 31]
 */
...
/**
 * @brief Shell handler for 'mem_test' command[cite: 31].
 * Usage: mem_test <addr> [size_in_bytes][cite: 31]
 */
void mem_test_handler(int nb_params, char **params)
{
    char *c;
    uint32_t *addr;
    unsigned int size = 1024; // Default 1KB test[cite: 31]
    ...
    // Pattern 1: Address as data[cite: 31]
...
/**
 * @brief Shell handler for 'mem_cmp' command[cite: 31].
 * Usage: mem_cmp <addr1> <addr2> <count_words>[cite: 31]
 */
