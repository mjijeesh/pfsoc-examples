/*******************************************************************************
 * PolarFire SoC Discovery Kit - Step 2: Register Diagnostics & MDIO Suite
...
static void print_help(void) {
    PRINT_STRING("\r\n================ Step 2: Diagnostic & Register CLI ================\r\n");
    PRINT_STRING("  loopback pcs          - Toggle GEM PCS SGMII Loopback Mode\r\n");
    PRINT_STRING("  loopback phy          - Toggle VSC8221 PHY Near-End Loopback\r\n");
    ...
    PRINT_STRING("  phy dump              - Dump VSC8221 registers (0x00-0x0F)\r\n");
...
void mac_task(void *pvParameters) {
    ...
    PRINT_STRING("\r\n***** PolarFire SoC Discovery Kit - Step 2 Test *****\r\n");
    __enable_irq();
