...
This is modified to work with the latest version of the compiler on linux , debug from lim is working.


tested on the discovery kit.


Discovery Kit Tested
v7 :  Now the main application is runnign from u54_1, e51 is used to wake the u54_1 and will go for wfi mode. Makefiel modified for debug break point in u54_1
