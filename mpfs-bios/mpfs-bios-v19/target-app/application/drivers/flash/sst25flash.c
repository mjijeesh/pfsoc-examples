...
/* Select CoreSPI driver or MSS_SPI Driver based o nthe Baord/Design */
...
static int sst25_read_id_wrapper(uint8_t *mfr_id, uint8_t *dev_id)
{
    SST25_FLASH_read_device_id(mfr_id, dev_id);
    return 0;
}
