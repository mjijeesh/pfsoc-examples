 ...
 *   - MPFS_ICICLE_KIT_ES -> MMUART0 (&g_mss_uart1_lo)
 *   - MPFS_VIDEO_KIT     -> MMUART0 (&g_mss_uart1_lo)
 */
...
/**
 * @brief Dynamically initializes the U54_1 MMUART assigned to the target board.
 */
void uart_init(void)
{
    has_lookahead = 0;
