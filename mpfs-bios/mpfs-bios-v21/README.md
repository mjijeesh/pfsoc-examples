# PolarFire SoC Baremetal BIOS v21
...
1. using a board_config.h fiel in $(BOARD) folder for uart/spi/flash selections for each board.
2. Auto detection of spi flash memroy on CoreSPI - iclce baord - on board micron1gb tested ,
3. autodetection of spif lash on mss-spi ( mikrobus - discovery board - sst25/windbond 25xxx tested)
